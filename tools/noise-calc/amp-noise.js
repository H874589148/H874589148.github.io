...
var AMP_FIGS = {
    ...
    /* 折叠式：M1/M2 输入对 + M0 尾管；M5/M6 折叠电流源；M3/M4 + M7/M8(casc) PMOS 负载 */
    'folded': _svg(400, 290,
        _w(60, 16, 340, 16) + _t(60, 9, 'VDD') +
        _pmos(100, 56) + _pmos(280, 56) +
        _w(112, 38, 112, 16) + _w(292, 38, 292, 16) +
        _w(88, 56, 68, 56) + _t(64, 51, 'Vb2', 'end') +
        _w(268, 56, 296, 56) + _t(300, 51, 'Vb2') +
        _pmos(100, 110) + _pmos(280, 110) +
        _w(112, 74, 112, 92) + _w(292, 74, 292, 92) +
        _w(88, 110, 68, 110) + _t(64, 105, 'Vb3', 'end') +
        _w(268, 110, 296, 110) + _t(300, 105, 'Vb3') +
        _w(112, 128, 112, 190) + _w(292, 128, 292, 190) +
        _nmos(160, 160) + _nmos(240, 160) +
        _p('M172,142 L172,164 L112,164') + _d(112, 164) +
        _p('M232,142 L232,164 L292,164') + _d(292, 164) +
        _w(148, 160, 124, 160) + _t(120, 155, 'Vin+', 'end') +
        _w(228, 160, 252, 160) + _t(256, 155, 'Vin−') +
        _w(172, 178, 172, 196) + _w(232, 178, 232, 196) + _w(172, 196, 232, 196) + _d(202, 196) +
        _nmos(190, 236) + _w(202, 218, 202, 196) +
        _w(202, 254, 202, 264) + _gnd(202, 264) +
        _w(178, 236, 158, 236) + _t(154, 231, 'Vb', 'end') +
        _nmos(100, 226) + _nmos(280, 226) +
        _w(112, 190, 112, 208) + _w(292, 190, 292, 208) +
        _w(112, 244, 112, 252) + _gnd(112, 252) +
        _w(292, 244, 292, 252) + _gnd(292, 252) +
        _w(88, 226, 68, 226) + _t(64, 221, 'Vb4', 'end') +
        _w(268, 226, 296, 226) + _t(300, 221, 'Vb4') +
        _w(292, 164, 340, 164) + _t(344, 159, 'Vout') +
        _t(118, 68, 'M3') + _t(298, 68, 'M4') +
        _t(118, 122, 'M7') + _t(298, 122, 'M8') +
        _t(118, 240, 'M5') + _t(298, 240, 'M6') +
        _t(178, 148, 'M1') + _t(238, 148, 'M2') + _t(212, 240, 'M0'))
};
